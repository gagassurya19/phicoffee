...
export default function PreOrderForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      const newOrderId = `PRE-ORDER-${Date.now()}-${Math.random().toString(36).substr(2, 9)}`
      ...
      toast({
        title: "Error",
        description: "Failed to create pre-order. Please try again.",
        variant: "destructive",
      })
    } finally {
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Where will you pick up your coffee?" {...field} />
                </FormControl>
